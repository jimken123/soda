...
# ToConcordance
_Alias_:`ToConcordance`, `ConvertEntityToConcordance`
...
|Encoding           |[EncodingEnum](../Enums/EncodingEnum.md)|        |2       |UTF8 no BOM                                                    |                   |How the stream is encoded.                                                                                                                          |
|Delimiter          |`string`                                |        |3       |                                                              |                   |The delimiter to use to separate fields.                                                                                                            |
|QuoteCharacter     |`string`                                |        |4       |þ                                                              |                   |The quote character to use. Should be a single character or an empty string. If it is empty then strings cannot be quoted.                          |

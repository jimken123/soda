...
function DocVersionBannerEnabled({ className, versionMetadata }) {
  ...
  const { savePreferredVersionName: savePreferredVersionNameDefault } =
  ...
  const { latestDocSuggestion, latestVersionSuggestion } = useDocVersionSuggestions(pluginId); // try to link to same doc in latest version (not always possible)
    ...
    >
      ...
      <div className="margin-top--md">
        <LatestVersionSuggestionLabel
          ...
          onClick={() => {
            savePreferredVersionNameDefault(latestVersionSuggestion.name);
            savePreferredVersionNameSteps(latestVersionSuggestion.name);
          }}
        />
      </div>
    </div>

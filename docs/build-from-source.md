...
[Phoenix Console](https://gitlab.com/Phoenix/console)
...
Release packages are available from [nuget.org](https://www.nuget.org/profiles/Phoenix).

## Example - Build Phoenix Console for Linux

Building on Ubuntu 20.04:

```bash
git clone git@gitlab.com:Phoenix/console.git
cd console/
...
publish/Phoenix run scl "FileRead './publish/connectors.json' | FromJson | Format"
```
